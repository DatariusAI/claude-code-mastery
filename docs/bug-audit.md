...
| 7 | LOW | `C:\Users\kewlf\package.json` | Home directory `package.json` contained two concatenated JSON objects (malformed). This broke all `npm install` and `npx` commands system-wide. Fixed during this session. | Fixed |
