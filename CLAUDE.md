...
- **Week 7: IN PROGRESS** — Capstone Notification Service API (Python/Flask). See week-7/CAPSTONE_PLAN.md for scope and session plan. Session A: scaffold dropped, REQ-007 verified, dashboard flipped to in-progress.
