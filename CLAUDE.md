...
- **Week 7: IN PROGRESS** — Capstone Notification Service API (Python/Flask). As of Session D: REPORT.md with 4 submission notes + rubric self-assessment (110/110 with bonuses) + ROI table + demo checklist; dashboard mini-project panel fully populated with 5 Mermaid diagrams; deliverables checklist ticked through Session D; 'View on GitHub' button live. Session E ships the submission PDF and flips W7 to COMPLETE.
